...
def check_company(company_name, is_new):
    ...
    Если возможно давай ссылки на страницы, где ты нашел информацию.
    Пиши ссылки только на существующие сайты, где ты нашел информацию по компании. Перепроверяй ссылки. Обязательно присылай только существующие ссылки на страницы.
